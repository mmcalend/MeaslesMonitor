**The Measles Monitor** is an interactive Streamlit dashboard developed by the ASU Health Observatory to visualize, compare, and simulate measles outbreaks in the United States—especially focusing on the 2025 resurgence.

 [Live App on Streamlit Cloud](#) *(update this with your link)*
...
- **Pandas / NumPy** – for data handling and modeling
- **GitHub** – for live-updated CSV data and deployment
