...
def tab5_view(df_schools):
    ...
    <div style='text-align:center; margin-bottom:1.5em;'>
      ...
      <p style='font-size:1.1rem; color:#555; margin-top:0; margin-bottom:0.5em;'>
        Estimate the impact of measles on school communities, including infections, hospitalizations, absences, and more.<br>
        <em>Note: Schools with fewer than 20 students were excluded.</em>
      </p>
    ...
    <div style='display:flex; flex-wrap:wrap; justify-content:center; gap:1rem; margin-bottom:2em;'>
      <div title='PubMed: R₀ = 12 (PMID: 28757186)' style='background:#2f2e41; color:white; padding:1rem; border-radius:10px; width:200px; cursor:help;'>
        <strong>R₀:</strong><br>12 <a href="https://pubmed.ncbi.nlm.nih.gov/28757186/" target="_blank" style="color:#a5c9ff;">PubMed</a>
      </div>
      <div title='ADHS: MMR kindergarten coverage for 2024–25 (schools ≥20 students)' style='background:#3d3c5a; color:white; padding:1rem; border-radius:10px; width:200px; cursor:help;'>
      ...
      <div title='NFID: Hospitalization rate ≈ 20%' style='background:#47465c; color:white; padding:1rem; border-radius:10px; width:200px; cursor:help;'>
      ...
      <div title='UChicago Medicine: Death rate ≈ 0.03%' style='background:#4e4d6b; color:white; padding:1rem; border-radius:10px; width:200px; cursor:help;'>
      ...
      <div title='Isolation = 4 days post-rash (AAC R9-6-355)' style='background:#5A4E7A; color:white; padding:1rem; border-radius:10px; width:200px; cursor:help;'>
      ...
      <div title='Quarantine = 21 days (ADHS)' style='background:#6d6b85; color:white; padding:1rem; border-radius:10px; width:200px; cursor:help;'>
    ...
    attack = min(z, 1.0)
    total_cases = attack * enrollment
    hosp_rate, death_rate, q_days = 0.2, 0.0003, 21
    total_exposed = susceptible
    total_days_missed = total_exposed * q_days
    ...
    <div class="blocked-text">
      ...
      This calendar grid shows the next 30 school weekdays with shaded cells marking quarantine days. Hover for day number.
    </div>
    """, unsafe_allow_html=True)
    ...
    summary_html = f"""
    <div style='display:flex; flex-wrap:wrap; justify-content:center; gap:1rem; margin-bottom:2em;'>
      <div title='Total Infected = Enrollment × Attack Rate' style='background:{colors[-3]}; color:white; padding:1rem; border-radius:8px; width:160px; cursor:help;'>
      ...
      <div title='Exposed = Enrollment × (1 - Immune Rate)' style='background:{colors[-6]}; color:white; padding:1rem; border-radius:8px; width:160px; cursor:help;'>
        <strong>Exposed</strong><br>{int(total_exposed):,}
      </div>
      <div title='Missed Days = Exposed × 21' style='background:{colors[-7]}; color:white; padding:1rem; border-radius:8px; width:160px; cursor:help;'>
