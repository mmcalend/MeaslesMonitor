...
def tab2_view(df):
    ...
    <div class="blocked-text">
        This is an animated map visualizing the number of cumulative confirmed measles cases in the United States by week (using Sunday as a starting date) throughout 2025.
